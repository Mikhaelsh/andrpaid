<?php $__env->startSection('title', __('adminMonitoring.title')); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container monitoring-container">
            <div class="row g-4 mb-5">
                    ...
                    <div class="mon-card">
                        <div class="mon-card-header">
                            <h6 class="fw-bold mb-0 text-uppercase text-muted small">
                                <?php echo e(__('adminMonitoring.activity_volume')); ?>

                                <?php if(request('date_from') || request('date_to')): ?>
                                    <span class="badge bg-primary ms-2"><?php echo e(__('adminMonitoring.filtered_range')); ?></span>
                                <?php else: ?>
                                    <span class="badge bg-light text-dark border ms-2"><?php echo e(__('adminMonitoring.last_7_days')); ?></span>
                                <?php endif; ?>
                            </h6>
                        </div>
                        <div class="p-3">
                ...
                <div class="col-md-4">
                    <div class="mon-card">
                        <div class="mon-card-header">
                            <h6 class="fw-bold mb-0 text-uppercase text-muted small"><?php echo e(__('adminMonitoring.event_distribution')); ?></h6>
                        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <div class="filter-sidebar">
                        <div class="mon-card p-4">
                            <h5 class="fw-bold mb-4"><i class="bi bi-funnel-fill me-2"></i><?php echo e(__('adminMonitoring.filter_logs')); ?></h5>
                            <form action="<?php echo e(url()->current()); ?>" method="GET">
                                <div class="filter-group mb-3">
                                    <label><?php echo e(__('adminMonitoring.label_user')); ?></label>
                                    <select class="form-select form-select-custom" name="user_id">
                                        <option value=""><?php echo e(__('adminMonitoring.all_users')); ?></option>
                                ...
                                <div class="filter-group mb-3">
                                    <label><?php echo e(__('adminMonitoring.label_event')); ?></label>
                                    <select class="form-select form-select-custom" name="type">
                                        <option value=""><?php echo e(__('adminMonitoring.all_events')); ?></option>
                                        <option value="login" <?php echo e(request('type') == 'login' ? 'selected' : ''); ?>><?php echo e(__('adminMonitoring.opt_login')); ?></option>
                                        <option value="logout" <?php echo e(request('type') == 'logout' ? 'selected' : ''); ?>><?php echo e(__('adminMonitoring.opt_logout')); ?></option>
                                    </select>
                                </div>

                                <div class="filter-group mb-3">
                                    <label><?php echo e(__('adminMonitoring.label_from')); ?></label>
                                    <input type="date" class="form-control form-control-custom" name="date_from"
                                        value="<?php echo e(request('date_from')); ?>">
                                </div>

                                <div class="filter-group mb-4">
                                    <label><?php echo e(__('adminMonitoring.label_to')); ?></label>
                                    <input type="date" class="form-control form-control-custom" name="date_to"
                                        value="<?php echo e(request('date_to')); ?>">
                                </div>

                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary fw-bold"><?php echo e(__('adminMonitoring.btn_apply')); ?></button>
                                    <a href="<?php echo e(url()->current()); ?>" class="btn btn-light text-muted"><?php echo e(__('adminMonitoring.btn_reset')); ?></a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-9">
                    <div class="mon-card">
                        <div class="mon-card-header">
                            <div>
                                <h5 class="fw-bold mb-1"><?php echo e(__('adminMonitoring.feed_title')); ?></h5>
                                <span class="text-muted small">
                                    <?php echo e(__('adminMonitoring.showing_events', [
                        ...
                        <div class="card-body p-4">
                                            ...
                                            <div class="timeline-content">
                                                <div class="d-flex justify-content-between align-items-start mb-2">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="log-badge <?php echo e($badgeClass); ?>">
                                                            <?php echo e($log->type == 'login' ? __('adminMonitoring.opt_login') : ($log->type == 'logout' ? __('adminMonitoring.opt_logout') : ucfirst($log->type))); ?>
                                                ...
                                                <p class="mb-0 text-muted small">
                                                    <?php if($log->type == 'login'): ?>
                                                        <?php echo e(__('adminMonitoring.msg_logged_in')); ?>

                                                    <?php elseif($log->type == 'logout'): ?>
                                                        <?php echo e(__('adminMonitoring.msg_logged_out')); ?>

                                                    <?php else: ?>
                                                        <?php echo e(__('adminMonitoring.performed_action', ['type' => $log->type])); ?>
                            ...
                            <?php else: ?>
                                <div class="text-center py-5">
                                    ...
                                    <h5 class="fw-bold text-muted"><?php echo e(__('adminMonitoring.no_logs')); ?></h5>
                                    <p class="text-muted small"><?php echo e(__('adminMonitoring.adjust_filters')); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (labels.length > 0) {
                        new Chart(volumeCtx, {
                            ...
                            data: {
                                labels: labels,
                                datasets: [{
                                        label: "<?php echo e(__('adminMonitoring.chart_logins')); ?>",
                                        data: loginData,
                                        borderColor: '#198754',
                                    ...
                                    {
                                        label: "<?php echo e(__('adminMonitoring.chart_logouts')); ?>",
                                        data: logoutData,
                                        borderColor: '#ffc107',
                    ...
                    if ((totalLogins + totalLogouts) > 0) {
                        ...
                        new Chart(distCtx, {
                            type: 'doughnut',
                            data: {
                                labels: ["<?php echo e(__('adminMonitoring.chart_logins')); ?>", "<?php echo e(__('adminMonitoring.chart_logouts')); ?>"],
                                datasets: [{
    ...
    <?php if($type === 'globalStatistics'): ?>
        ...
        <div class="container monitoring-container">
            <div class="row g-4 mb-5">
                <div class="col-md-4">
                    <div class="stats-card">
                        <div>
                            <h6 class="text-muted text-uppercase small fw-bold mb-1"><?php echo e(__('adminMonitoring.total_universities')); ?></h6>
                ...
                <div class="col-md-4">
                    <div class="stats-card">
                        <div>
                            <h6 class="text-muted text-uppercase small fw-bold mb-1"><?php echo e(__('adminMonitoring.total_lecturers')); ?></h6>
                ...
                <div class="col-md-4">
                    <div class="stats-card">
                        <div>
                            <h6 class="text-muted text-uppercase small fw-bold mb-1"><?php echo e(__('adminMonitoring.total_papers')); ?></h6>
                    ...
                    <div class="mon-card p-1 h-100">
                        <div class="card-body p-2 position-relative">
                            ...
                            <div class="position-absolute top-0 end-0 m-3 d-flex gap-2" style="z-index: 500;">
                                <button class="map-filter-btn active" onclick="setRoleFilter('all')"><?php echo e(__('adminMonitoring.map_all')); ?></button>
                                <button class="map-filter-btn" onclick="setRoleFilter('university')"><?php echo e(__('adminMonitoring.map_universities')); ?></button>
                                <button class="map-filter-btn" onclick="setRoleFilter('lecturer')"><?php echo e(__('adminMonitoring.map_lecturers')); ?></button>
                            </div>

                            <div class="position-absolute bottom-0 start-0 m-4 bg-white p-3 rounded-3 shadow-sm"
                                style="z-index: 500; min-width: 250px;">
                                <span class="text-muted small fw-bold text-uppercase d-block mb-1"><?php echo e(__('adminMonitoring.selected_region')); ?></span>
                                <h5 class="fw-bold text-primary mb-2" id="selectedRegionName"><?php echo e(__('adminMonitoring.all_indonesia')); ?></h5>
                                <button class="btn btn-sm btn-outline-secondary w-100" onclick="resetMap()">
                                    <i class="bi bi-arrow-counterclockwise me-1"></i> <?php echo e(__('adminMonitoring.reset_view')); ?>
                    ...
                    <div class="mon-card p-3 h-100">
                        <div class="user-list-wrapper">
                            <div class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2">
                                <h6 class="fw-bold mb-0"><i class="bi bi-geo-alt me-2"></i><?php echo e(__('adminMonitoring.user_directory')); ?></h6>
                            ...
                            <div id="emptyListState" class="text-center py-5 d-none">
                                ...
                                <h6 class="fw-bold text-muted small"><?php echo e(__('adminMonitoring.no_users')); ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-8">
                    <div class="chart-card h-100">
                        <div class="chart-header">
                            <div>
                                <h5 class="fw-bold mb-1"><?php echo e(__('adminMonitoring.growth_trends')); ?></h5>
                                <p class="text-muted small mb-0"><?php echo e(__('adminMonitoring.growth_sub')); ?></p>
                            </div>
                            ...
                            <form action="<?php echo e(url()->current()); ?>" method="GET"
                                ...
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-light border-end-0"><?php echo e(__('adminMonitoring.label_from_short')); ?></span>
                                    <input type="date" class="form-control border-start-0 ps-1" name="date_from"
                                        value="<?php echo e(request('date_from')); ?>">
                                </div>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-light border-end-0"><?php echo e(__('adminMonitoring.label_to_short')); ?></span>
                                    <input type="date" class="form-control border-start-0 ps-1" name="date_to"
                                        value="<?php echo e(request('date_to')); ?>">
                                </div>
                                <button type="submit" class="btn btn-primary btn-sm fw-bold px-3"><?php echo e(__('adminMonitoring.btn_filter')); ?></button>
                                <?php if(request('date_from')): ?>
                                    <a href="<?php echo e(url()->current()); ?>?type=globalStatistics"
                                        class="btn btn-light btn-sm border"><?php echo e(__('adminMonitoring.btn_reset')); ?></a>
                                <?php endif; ?>
                            </form>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="chart-card h-100">
                        <div class="chart-header">
                            <h5 class="fw-bold mb-0"><?php echo e(__('adminMonitoring.user_composition')); ?></h5>
                        </div>
                        ...
                        <div class="text-center mt-3 pt-3 border-top">
                            <div class="row text-center">
                                <div class="col-6 border-end">
                                    ...
                                    <small class="text-muted"><?php echo e(__('adminMonitoring.map_universities')); ?></small>
                                </div>
                                <div class="col-6">
                                    <h5 class="fw-bold mb-0 text-success"><?php echo e($stats['lecturers']); ?></h5>
                                    <small class="text-muted"><?php echo e(__('adminMonitoring.map_lecturers')); ?></small>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            ...
            window.lang = {
                all_indonesia: "<?php echo e(__('adminMonitoring.all_indonesia')); ?>",
                count_found: "<?php echo e(__('adminMonitoring.count_found', ['count' => ':count'])); ?>",
                chart_univ: "<?php echo e(__('adminMonitoring.chart_universities')); ?>",
                chart_lect: "<?php echo e(__('adminMonitoring.chart_lecturers')); ?>",
                chart_paper: "<?php echo e(__('adminMonitoring.chart_papers')); ?>",
            };
