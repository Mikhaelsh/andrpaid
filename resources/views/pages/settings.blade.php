                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-select" name="province_id">
                                            @foreach ($allProvinces as $eachProvince)
                                                <option {{ $eachProvince->name === $province->name ? "selected" : "" }} value="{{ $eachProvince->provinceId }}">{{ $eachProvince->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Last changed {{  $user->latest_password_updated_at->diffForHumans()  }}</p>
                                </div>
                                <button class="btn btn-outline-primary btn-sm" type="button" data-bs-toggle="collapse"
