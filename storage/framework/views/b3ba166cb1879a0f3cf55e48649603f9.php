    ...
    <div class="login-page-wrapper">
        ...
        <?php elseif($type === 'specificRole'): ?>
            <form action="/register/<?php echo e($role); ?>/insert" method="POST" class="form auth-3d-form">
                ...
                <div class="input-wrapper">
                    <textarea name="description" rows="2" placeholder="Short Bio (Optional, max 200 chars)" maxlength="200"><?php echo e(old('description')); ?></textarea>
                </div>
                ...
                <div class="input-wrapper">
                    <select name="province" required>
                        ...
                        <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($province->provinceId); ?>"
                                <?php echo e(old('province') === $province->provinceId ? 'selected' : ''); ?>>
