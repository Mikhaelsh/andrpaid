...
@section('additionalCSS')
    ...
    <style>
        ...
        .code-card {
            background: #1e1e1e; /* Dark theme for code container */
            color: #d4d4d4;
            border-radius: 8px;
            overflow: hidden;
        ...
        .code-content {
            padding: 15px;
            background: #fff; /* Reset for iframes/embeds */
        }
        .dataset-preview-img {
            width: 100%;
            height: 150px;
        ...
        .dataset-preview-img:hover { transform: scale(1.02); }
    </style>
@endsection
...
@section('content')
    ...
    <div class="row mt-5 g-4" style="margin-bottom: 50px; margin-left: 50px; margin-right: 50px;">
                    ...
                    <div class="d-flex flex-column gap-3">
                        @foreach($paper->formulas as $form)
                            <div class="border rounded p-3 position-relative bg-white">
                                ...
                                {{-- 
                                    1. Target Container for KaTeX. 
                                    2. LEFT EMPTY on purpose. No {{ $form['latex'] }} here.
                                    3. JavaScript will inject the rendered image here.
                                --}}
        ...
        {{-- 3. CODE IMPLEMENTATION SECTION (New) --}}
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="current_image_preview" class="mt-2 d-none">
                                    ...
                                    <img src="" id="edit_ds_img_preview" style="height: 60px; border-radius: 4px; border: 1px solid #ddd;">
                                </div>
                            </div>
                    ...
                    <form action="/{{ $user->profileId }}/paper/{{ $paper->paperId }}/methodology/add-formula" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="latex" id="latexInput" class="form-control font-monospace" placeholder="e.g. a^2 + b^2 = c^2" required oninput="renderPreview()">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Description</label>
                                <input type="text" name="description" class="form-control" placeholder="e.g. Pythagorean theorem calculation" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                    ...
                    <form action="/{{ $user->profileId }}/paper/{{ $paper->paperId }}/methodology/add-code" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="e.g. Data Preprocessing Notebook" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="embed_code" class="form-control font-monospace" rows="4" placeholder="<script src='...'> or <iframe src='...'>"></textarea>
                                <div class="form-text">Paste the full embed code provided by the platform (Gist script or Colab iframe).</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Description</label>
