<?php $__env->startSection('title', 'User Reports & Feedback'); ?>
            ...
            <div class="col-lg-4 d-flex flex-column gap-3">
                <div class="report-stat-card">
                    ...
                    <div>
                        ...
                        <h2 class="fw-bold mb-0"><?php echo e($stats['total']); ?></h2>
                    </div>
                </div>
                <div class="report-stat-card">
                    ...
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-warning"><?php echo e($stats['pending']); ?></h2>
                    </div>
                </div>
                <div class="report-stat-card">
                    ...
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-success"><?php echo e($stats['resolved']); ?></h2>
                    </div>
                </div>
            </div>
                ...
                <form action="<?php echo e(url()->current()); ?>" method="GET" class="row g-2 align-items-center">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" name="search" class="form-control border-start-0 ps-0"
                                placeholder="Search user or ID..." value="<?php echo e(request('search')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <select class="form-select" name="status" onchange="this.form.submit()">
                            ...
                            <option value="reviewing" <?php echo e(request('status') == 'reviewing' ? 'selected' : ''); ?>>In Review
                            </option>
                            <option value="resolved" <?php echo e(request('status') == 'resolved' ? 'selected' : ''); ?>>Resolved
                            </option>
                            <option value="dismissed" <?php echo e(request('status') == 'dismissed' ? 'selected' : ''); ?>>Dismissed
                            </option>
                        </select>
                    </div>
                    <div class="col-md-2 text-end">
                        <a href="<?php echo e(url()->current()); ?>" class="btn btn-light text-muted w-100">Reset</a>
                    </div>
                </form>
            </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span
                                            class="badge bg-info-subtle text-info border border-info-subtle"><?php echo e(ucfirst($report->status)); ?></span>
                                    <?php endif; ?>
                                </td>
