                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div
                                ...
                                <span class="fw-bold small"><?php echo e(Auth::user()->name); ?></span>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="paperType" class="form-select paper-form-select" required>
                                    ...
                                    <?php $__currentLoopData = $paperTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paperType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($paperType->paperTypeId); ?>"><?php echo e($paperType->name); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Data D\BINUS FILES\Web Programming\andrpaid\resources\views/pages/papers-create.blade.php ENDPATH**/ ?>