            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    <div class="section-card">
                        ...
                        @else
                            <textarea name="summary" class="form-control" rows="6" placeholder="Synthesize the key results of your research here..." {{ $canEdit ? '' : 'disabled' }}>{{ $paper->conclusion_summary }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="section-card">
                        ...
                        @else
                            <textarea name="limitations" class="form-control" rows="8" placeholder="What were the constraints? (e.g. Sample size, time, data availability)" {{ $canEdit ? '' : 'disabled' }}>{{ $paper->conclusion_limitations }}</textarea>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="section-card">
                        ...
                        @else
                            <textarea name="future_works" class="form-control" rows="8" placeholder="Suggest avenues for further research..." {{ $canEdit ? '' : 'disabled' }}>{{ $paper->conclusion_future_works }}</textarea>
                        @endif
                    </div>
                </div>
            </div>

            {{-- Floating Save Button (Only if draft and editable) --}}
            @if($canInteract)
