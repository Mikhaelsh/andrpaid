    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-end mb-5">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/export-bibtex" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="workspace-card p-4 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo e($progress); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <?php if(!empty($paper->themes)): ?>
                            <?php $__currentLoopData = $paper->themes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/remove-theme" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                        ...
                        <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/add-theme" 
                              method="POST" 
                              id="addThemeForm" 
                              style="display: none;" 
                              class="w-100 mt-2">
                    ...
                    <div class="d-flex flex-column gap-3">
                        <?php $__currentLoopData = array_reverse($paper->references_data); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                            ...
                            <div class="workspace-card reference-card p-4"
                                 data-title="<?php echo e($ref['title']); ?>" 
                                 data-author="<?php echo e($ref['author']); ?>" 
                                 data-year="<?php echo e($ref['year']); ?>" 
                                 data-journal="<?php echo e($ref['publication'] ?? ''); ?>"
                                 data-url="<?php echo e($ref['url'] ?? ''); ?>">

                                <div class="d-flex gap-3">
                                    <div class="module-icon <?php echo e($ref['is_analyzed'] ? 'bg-success text-success' : 'bg-secondary text-secondary'); ?> bg-opacity-10 flex-shrink-0" style="width: 50px; height: 50px;">
                                        <i class="bi <?php echo e($ref['is_analyzed'] ? 'bi-check-circle-fill' : 'bi-hourglass-split'); ?> fs-5"></i>
                                    </div>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted small mb-2">
                                            ...
                                            <?php if(!empty($ref['publication'])): ?> • <i><?php echo e($ref['publication']); ?></i> <?php endif; ?>
                                        </p>
