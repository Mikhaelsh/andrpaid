<?php $__env->startSection('title', 'Collaboration - ' . $paper->title); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container py-5">
        <?php if(!$isOwner && $myPendingInvite): ?>
                ...
                <div class="card-body p-4">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">
                                    <span class="fw-bold text-dark"><?php echo e($myPendingInvite->fromLecturer->user->name); ?></span>
                                    has invited you to join this paper as a
                                    <span class="badge bg-info text-dark bg-opacity-25 border border-info px-2">
                                        <?php echo e($myPendingInvite->collaboration->role); ?>
                        ...
                        <div class="d-flex gap-2 w-100 w-md-auto justify-content-end">
                            <form
                                action="/<?php echo e($paper->lecturer->user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/accept-invitation"
                                method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="invitation_id" value="<?php echo e($myPendingInvite->id); ?>">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow rounded-4">
                        ...
                        <div class="modal-body p-4">
                            ...
                            <form
                                action="/<?php echo e($paper->lecturer->user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/reject-invitation"
                                method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="invitation_id" value="<?php echo e($myPendingInvite->id); ?>">
        ...
        <?php if($isOwner): ?>
            <div class="card border-0 shadow-sm mb-5 overflow-hidden">
                <div class="card-body p-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3">
                        <div
                            class="rounded-circle p-3 <?php echo e($paper->openCollaboration ? 'bg-success bg-opacity-10 text-success' : 'bg-secondary bg-opacity-10 text-secondary'); ?>">
                            <i class="bi <?php echo e($paper->openCollaboration ? 'bi-unlock-fill' : 'bi-lock-fill'); ?> fs-4"></i>
                        </div>
                        <div>
                            <h5 class="fw-bold mb-1">Collaboration is <?php echo e($paper->openCollaboration ? 'Open' : 'Closed'); ?>

                            </h5>
                            <p class="text-muted mb-0 small">
                                <?php echo e($paper->openCollaboration
                    ...
                    <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/toggle-collaboration"
                        method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <div class="progress" style="height: 4px;">
                    <div class="progress-bar <?php echo e($paper->openCollaboration ? 'bg-success' : 'bg-secondary'); ?>"
                        style="width: 100%"></div>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="row g-4 mb-4">
            ...
            <?php $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-6 col-lg-4">
                    <?php if($slot->lecturer): ?>
                        
                        <div class="card collab-card h-100 rounded-4">
                            <div class="card-header bg-light border-0 py-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="fw-bold text-dark mb-0"><?php echo e($slot->role); ?></h6>
                                    <?php if($isOwner): ?>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm">
                                                <li>
                                                    <button class="dropdown-item small edit-role-trigger"
                                                        ...
                                                        data-id="<?php echo e($slot->id); ?>" data-role="<?php echo e($slot->role); ?>"
                                                        data-description="<?php echo e($slot->description); ?>">
                                                        Edit Role
                                                    </button>
                                                </li>
                                                ...
                                                <li>
                                                    <button class="dropdown-item text-danger small remove-member-trigger"
                                                        ...
                                                        data-bs-target="#removeMemberModal" data-id="<?php echo e($slot->id); ?>"
                                                        data-name="<?php echo e($slot->lecturer->user->name); ?>">
                                                        Remove Member
                                                    </button>
                                                </li>
                                            </ul>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <div class="member-avatar flex-shrink-0" style="width: 50px; height: 50px;">
                                        <img src="https://ui-avatars.com/api/?name=<?php echo e($slot->lecturer->user->name); ?>&background=0d6efd&color=fff"
                                            class="shadow-sm" alt="">
                                    </div>
                                    <div>
                                        <h6 class="fw-bold mb-0 text-dark"><?php echo e($slot->lecturer->user->name); ?></h6>
                                        <small class="text-muted"><?php echo e($slot->lecturer->affiliation); ?></small>
                                    </div>
                                </div>
                                <p class="small text-muted mb-0"><?php echo e($slot->description); ?></p>
                            </div>
                            <div class="card-footer bg-white border-0 pb-4 pt-0">
                                <a href="/<?php echo e($slot->lecturer->user->profileId); ?>/overview"
                                    class="btn btn-outline-light text-dark border-secondary border-opacity-25 btn-sm w-100 rounded-pill">View
                                    Profile</a>
                            </div>
                        </div>
                    <?php else: ?>
                        ...
                        <div class="card vacant-card h-100 rounded-4">
                            <div class="card-header bg-transparent border-0 py-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="fw-bold text-muted mb-0"><?php echo e($slot->role); ?></h6>
                                    <?php if($isOwner): ?>
                                        <form
                                            action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/remove-role"
                                            method="POST">
                                            <?php echo csrf_field(); ?>

                                            <input type="hidden" name="roleId" value="<?php echo e($slot->id); ?>">
                            ...
                            <div class="card-body p-4 text-center d-flex flex-column justify-content-center">
                                ...
                                <p class="small text-muted mb-3"><?php echo e($slot->description); ?></p>
                                ...
                                <?php else: ?>
                                    ...
                                    <?php else: ?>
                                        <button type="button"
                                            ...
                                            data-slot-id="<?php echo e($slot->id); ?>"
                                            data-role-name="<?php echo e($slot->role); ?>">
                                            Apply for Role
                                        </button>
                                    <?php endif; ?>
                                    <?php endif; ?>
        ...
        <?php if($isOwner && $invitations->count() != 0): ?>
            <div class="mb-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold text-dark mb-0">
                        <i class="bi bi-send-fill text-secondary me-2"></i> Sent Invitations
                        <span class="badge bg-secondary rounded-pill ms-2"><?php echo e(count($invitations)); ?></span>
                    </h5>
                    ...
                    <?php if($hasFinalized): ?>
                        <form
                            action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/clear-invitation-history"
                            method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3">
                                <div class="d-flex align-items-start gap-3 w-100">
                                    <div class="member-avatar flex-shrink-0" style="width: 56px; height: 56px;">
                                        <img src="https://ui-avatars.com/api/?name=<?php echo e($inv->toLecturer->user->name); ?>&background=random&color=fff"
                                            alt="Profile" class="rounded-circle border">
                                    </div>

                                    <div class="w-100">
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <h6 class="fw-bold mb-0 text-dark fs-5"><?php echo e($inv->toLecturer->user->name); ?>

                                            </h6>
                                        </div>

                                        <div class="d-flex flex-wrap align-items-center gap-3 text-muted small mb-2">
                                            <?php if($inv->toLecturer->affiliation): ?>
                                                <div class="d-flex align-items-center">
                                                    <i class="bi bi-building me-1"></i>
                                                    <?php echo e($inv->toLecturer->affiliation->university->user->name); ?>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                Invited as: <strong
                                                    class="text-dark ms-1"><?php echo e($inv->collaboration->role); ?></strong>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <i class="bi bi-clock me-1"></i>
                                                <?php echo e($inv->updated_at->diffForHumans()); ?>

                                            </div>
                                        </div>

                                        <?php if($inv->status === 'rejected' && $inv->message): ?>
                                            <div
                                                ...
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0 text-dark small fst-italic">"<?php echo e($inv->message); ?>"
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="d-flex flex-column align-items-end gap-2 mt-2 mt-md-0">
                                    ...
                                    <form
                                        action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/cancel-invitation"
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="invitation_id" value="<?php echo e($inv->id); ?>">
        ...
        <?php if($isOwner && $requests->count() != 0): ?>
            <div class="mb-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold text-dark mb-0">
                        <i class="bi bi-inbox-fill text-primary me-2"></i> All Requests
                        <span class="badge bg-primary rounded-pill ms-2"><?php echo e(count($requests)); ?></span>
                    </h5>
                    ...
                    <?php if($hasFinalizedRequests): ?>
                        <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/clear-request-history" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-link text-muted text-decoration-none btn-sm fw-bold">
                                <i class="bi bi-trash3 me-1"></i> Clear History
                            </button>
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3">
                                <div class="d-flex gap-3 w-100">
                                    <div class="member-avatar flex-shrink-0" style="width: 48px; height: 48px;">
                                        <img src="https://ui-avatars.com/api/?name=<?php echo e($req->fromLecturer->user->name); ?>&background=random&color=fff"
                                            alt="Profile" class="rounded-3">
                                    </div>

                                    <div class="w-100">
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <h6 class="fw-bold mb-0 text-dark"><?php echo e($req->fromLecturer->user->name); ?></h6>
                                            <span class="text-muted small">&bull; <?php echo e($req->created_at->diffForHumans()); ?></span>
                                        </div>

                                        <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                                            <?php if($req->toLecturer->affiliation): ?>
                                                <span class="small text-muted">
                                                    <i class="bi bi-building me-1"></i> <?php echo e($req->toLecturer->affiliation->university->user->name); ?>

                                                </span>
                                            <?php endif; ?>

                                            <span class="badge bg-light text-dark border fw-normal small">
                                                Applying for: <strong><?php echo e($req->collaboration->role); ?></strong>
                                            </span>
                                        </div>
                                ...
                                <div class="d-flex flex-column align-items-end gap-2 mt-2 mt-md-0">
                                    ...
                                    <?php if($req->status === 'pending'): ?>
                                        <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/accept-request" method="POST" class="w-100">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="requestId" value="<?php echo e($req->id); ?>">
                                        ...
                                        <button type="button"
                                            ...
                                            data-applicant-name="<?php echo e($req->toLecturer->user->name); ?>">
                                            Reject
                                        </button>
                                    <?php else: ?>
                                        <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/remove-request" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="requestId" value="<?php echo e($req->id); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <div class="modal-body p-4">
                    ...
                    <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/apply-for-role"
                        method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="editRoleModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <div class="modal-body p-4">
                    <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/edit-role"
                        method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="removeMemberModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <div class="modal-body p-4">
                    <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/remove-member"
                        method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="addRoleModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <div class="modal-body p-4">
                    <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/create-new-role"
                        method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
    ...
    <div class="modal fade" id="rejectRequestModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <div class="modal-body p-4">
                    <form action="/<?php echo e($user->profileId); ?>/paper/<?php echo e($paper->paperId); ?>/collaborations/reject-request" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const paperId = "<?php echo e($paper->paperId); ?>";
            const ownerId = "<?php echo e($paper->lecturer->user->profileId); ?>";
            ...
            function fetchUsers(query) {
                fetch(`<?php echo e(route('api.users.search.lecturer')); ?>?q=${query}`)
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Data D\BINUS FILES\Web Programming\andrpaid\resources\views/pages/paper-collaborations.blade.php ENDPATH**/ ?>