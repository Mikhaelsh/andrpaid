<nav class="navbar navbar-expand-md navbar-dark modern-navbar sticky-top">
    <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center"
            href="{{ route('dashboard', ['profileId' => Auth::user()->profileId]) }}">
            <div class="brand-logo-container me-2">
                <img src="{{ asset('images/logo.jpeg') }}" alt="Logo" class="brand-logo">
            </div>
            <span class="brand-text">{{ __('navbar.brand') }}</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
                ...
                @admin
                    <li class="nav-item">
                        <a class="nav-link px-3 {{ request()->is('admin-panel*') ? 'active' : '' }}" href="/admin-panel">
                            <i class="bi bi-shield-lock-fill me-1"></i> {{ __('navbar.admin_panel') }}
                        </a>
                    </li>
                @endadmin
                ...
                @notadmin
                    <li class="nav-item">
                        <a class="nav-link px-3 {{ request()->routeIs('dashboard') ? 'active' : '' }}"
                            href="{{ route('dashboard', ['profileId' => Auth::user()->profileId]) }}">
                            <i class="bi bi-speedometer2 me-1"></i> {{ __('navbar.dashboard') }}
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link px-3 {{ request()->is('find') ? 'active' : '' }}" href="/find">
                            <i class="bi bi-search me-1"></i> {{ __('navbar.find') }}
                        </a>
                    </li>
                    ...
                    @university
                        <li class="nav-item">
                            <a class="nav-link px-3 position-relative {{ request()->is('affiliations*') ? 'active' : '' }}"
                                href="/affiliations">
                                <i class="bi bi-person-check-fill me-1"></i> {{ __('navbar.affiliations') }}
                                ...
                                @if (isset($pendingRequestsCount) && $pendingRequestsCount > 0)
                                    <span
                                        ...
                                        <span class="visually-hidden">{{ __('navbar.new_requests') }}</span>
                                    </span>
                                @endif
                            </a>
                        </li>
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item me-2">
                    <a class="nav-link position-relative p-2 {{ request()->is('inboxes*') ? 'text-white active' : '' }}"
                        href="/inboxes" title="{{ __('navbar.inbox') }}">
                        ...
                        @if ($unreadInboxCount != 0)
                            <span
                                ...
                                <span class="visually-hidden">{{ __('navbar.new_alerts') }}</span>
                            </span>
                        @endif
                    </a>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end custom-dropdown mt-3 animate slideIn">
                        <li>
                            <h6 class="dropdown-header text-uppercase fw-bold">
                                @university
                                    {{ __('navbar.profile_org') }}
                                @else
                                    {{ __('navbar.profile_personal') }}
                                @enduniversity
                            </h6>
                        </li>
                        ...
                        @university
                            <li>
                                <a class="dropdown-item py-2" href="/{{ Auth::user()->profileId }}/overview">
                                    <i class="bi bi-building me-3"></i> {{ __('navbar.menu_overview') }}
                                </a>
                            </li>

                            <li>
                                <a class="dropdown-item py-2" href="/{{ Auth::user()->profileId }}/papers">
                                    <i class="bi bi-journal-text me-3"></i> {{ __('navbar.menu_publications') }}
                                </a>
                            </li>

                            <li>
                                <a class="dropdown-item py-2" href="/{{ Auth::user()->profileId }}/researchers">
                                    <i class="bi bi-people me-3"></i> {{ __('navbar.menu_researchers') }}
                                </a>
                            </li>
                        @enduniversity
                        ...
                        @lecturer
                            <li>
                                <a class="dropdown-item py-2" href="/{{ Auth::user()->profileId }}/overview">
                                    <i class="bi bi-person me-3"></i> {{ __('navbar.menu_profile') }}
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2" href="/{{ Auth::user()->profileId }}/papers">
                                    <i class="bi bi-journal-code me-3"></i> {{ __('navbar.menu_papers') }}
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2" href="/{{ Auth::user()->profileId }}/stars">
                                    <i class="bi bi-star me-3"></i> {{ __('navbar.menu_stars') }}
                                </a>
                            </li>
                        @endlecturer
                        ...
                        <li>
                            <a class="dropdown-item py-2" href="/settings">
                                <i class="bi bi-gear me-3"></i> {{ __('navbar.menu_settings') }}
                            </a>
                        </li>
                        ...
                        <li>
                            <form action="/logout" method="POST">
                                ...
                                <button type="submit" class="dropdown-item py-2 text-danger fw-bold">
                                    <i class="bi bi-box-arrow-right me-3"></i> {{ __('navbar.sign_out') }}
                                </button>
                            </form>
                        </li>
                    </ul>
