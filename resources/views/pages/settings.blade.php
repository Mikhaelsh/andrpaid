...
@section('content')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="url" class="form-control" name="linkedin_url"
                                                placeholder="https://linkedin.com/in/..." value="{{ $user->lecturer->linkedinUrl }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="url" class="form-control" name="portfolio_url"
                                                placeholder="https://mywebsite.com" value="{{ $user->lecturer->portfolioUrl }}">
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        window.researchFieldsData = @json($allResearchFields->map(fn($f) => [
            'id' => $f->id,
            'name' => $f->name
        ]));
